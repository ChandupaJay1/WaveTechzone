        ...
        <div class="row vh-100">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <?php if (isset($_GET['order_updated'])) { ?>
                    <div class="alert alert-success text-center"><?php echo htmlspecialchars($_GET['order_updated']); ?></div>
                <?php } ?>

                <?php if (isset($_GET['order_failed'])) { ?>
                    <div class="alert alert-danger text-center"><?php echo htmlspecialchars($_GET['order_failed']); ?></div>
                <?php } ?>
                        ...
                        <tbody>
                            <?php while ($order = $orders->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($order['users_user_id']); ?></td>
                                    <td><?php echo htmlspecialchars($order['order_date']); ?></td>
                                    <td><?php echo htmlspecialchars($order['user_phone']); ?></td>
                                    <td><?php echo htmlspecialchars($order['user_address']); ?></td>
                                    <td><a class="btn btn-sm btn-primary" href="editOrder.php?order_id=<?php echo htmlspecialchars($order['order_id']); ?>">Edit</a></td>
                                    <td><a class="btn btn-sm btn-danger" href="deleteOrder.php?order_id=<?php echo htmlspecialchars($order['order_id']); ?>">Delete</a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
